...
export restore_file='YOUR_PATH/fNIRS-mental-workload-classifiers/experiments/generic_models/DeepConvNet/binary/64vs4/TestBucket3/80/lr0.01_dropout0.25/checkpoint/best_model.statedict'
export n_epoch=300
