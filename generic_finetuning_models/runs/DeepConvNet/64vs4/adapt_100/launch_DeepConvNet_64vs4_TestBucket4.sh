...
export n_epoch=300
export restore_file='YOUR_PATH/fNIRS-mental-workload-classifiers/experiments/generic_models/DeepConvNet/binary/64vs4/TestBucket4/62/lr10.0_dropout0.25/checkpoint/best_model.statedict'
