...
export n_epoch=300
export restore_file='YOUR_PATH/fNIRS-mental-workload-classifiers/experiments/generic_models/DeepConvNet/binary/64vs4/TestBucket15/7/lr0.1_dropout0.5/checkpoint/best_model.statedict'
