...
export n_epoch=300
export restore_file="$YOUR_PATH/NuripsDataSet2021/experiments/FixedTrainValSplit_generic_models/EEGNet/binary/64vs4/TestBucket4/62/lr0.01_dropout0.5/checkpoint/best_model.statedict"
