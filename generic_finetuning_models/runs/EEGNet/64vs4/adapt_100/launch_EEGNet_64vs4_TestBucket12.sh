...
export n_epoch=300
export restore_file='YOUR_PATH/fNIRS-mental-workload-classifiers/experiments/generic_models/EEGNet/binary/64vs4/TestBucket12/49/lr1.0_dropout0.25/checkpoint/best_model.statedict'
