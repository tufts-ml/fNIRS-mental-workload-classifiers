...
export restore_file="$YOUR_PATH/NuripsDataSet2021/experiments/FixedTrainValSplit_generic_models/EEGNet/binary/64vs4/TestBucket3/80/lr0.1_dropout0.25/checkpoint/best_model.statedict"
export n_epoch=300
