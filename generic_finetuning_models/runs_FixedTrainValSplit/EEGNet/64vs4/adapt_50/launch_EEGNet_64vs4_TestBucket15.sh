...
export n_epoch=300
export restore_file='/cluster/tufts/hugheslab/zhuang12/HCI/NuripsDataSet2021/experiments/FixedTrainValSplit_generic_models/EEGNet/binary/64vs4/TestBucket15/7/lr0.1_dropout0.25/checkpoint/best_model.statedict'
