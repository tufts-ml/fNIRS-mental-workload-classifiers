...
### Demo
For example, if you want to train subject-specific DeepConvNet. Go to [runs](subject_specific_models/runs_FixedTrainFValSplit/window_size150) within the subject_sepcific_models folder
