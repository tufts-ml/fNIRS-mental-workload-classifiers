...
do
    export experiment_dir="/cluster/tufts/hugheslab/zhuang12/HCI/fNIRS-mental-workload-classifiers/experiments/generic_models/WhiteSubset/EEGNet/binary/21vs6/seed2/$SubjectId_of_interest"
