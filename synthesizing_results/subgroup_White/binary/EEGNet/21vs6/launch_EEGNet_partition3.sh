...
do
    export experiment_dir="YOUR_PATH/fNIRS-mental-workload-classifiers/experiments/generic_models/WhiteSubset/EEGNet/binary/21vs6/random_partition3/$SubjectId_of_interest"
