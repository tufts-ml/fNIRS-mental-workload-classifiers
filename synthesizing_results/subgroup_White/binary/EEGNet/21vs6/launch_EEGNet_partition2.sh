...
do
    export experiment_dir="YOUR_PATH/fNIRS-mental-workload-classifiers1/experiments/generic_models/WhiteSubset/EEGNet/binary/21vs6/seed3/$SubjectId_of_interest"
