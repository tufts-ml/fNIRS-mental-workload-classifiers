...
do
    ...
    if [[ $ACTION_NAME == 'submit' ]]; then
        ...
        sbatch < YOUR_PATH/fNIRS-mental_workload-classifiers/synthesizing_results/subject_specific_models/binary/DeepConvNet/synthesize_hypersearch_DeepConvNet_for_a_subject.slurm
    
    elif [[ $ACTION_NAME == 'run_here' ]]; then
        ## Use this line to just run interactively
        bash YOUR_PATH/fNIRS-mental_workload-classifiers/synthesizing_results/subject_specific_models/binary/DeepConvNet/synthesize_hypersearch_DeepConvNet_for_a_subject.slurm
    fi
