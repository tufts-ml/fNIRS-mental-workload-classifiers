...
do
    export experiment_dir="YOUR_PATH/fNIRS-mental-workload-classifiers/experiments/generic_finetuning_models/EEGNet/binary/train_100/64vs4/TestBucket13/$SubjectId_of_interest"
