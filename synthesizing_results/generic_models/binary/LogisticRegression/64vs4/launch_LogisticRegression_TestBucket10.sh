...
do
    export experiment_dir="/cluster/tufts/hugheslab/zhuang12/HCI/fNIRS-mental-workload-classifiers1/experiments/generic_models/LogisticRegression/binary/64vs4/TestBucket10/$SubjectId_of_interest"
