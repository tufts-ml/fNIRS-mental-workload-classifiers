...
do
    export experiment_dir="/cluster/tufts/hugheslab/zhuang12/HCI/fNIRS-mental-workload-classifiers/experiments/generic_models/EEGNet/binary/4vs4/TestBucket1/$SubjectId_of_interest"
