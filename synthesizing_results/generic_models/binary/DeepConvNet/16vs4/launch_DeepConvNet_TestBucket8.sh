...
do
    export experiment_dir="/cluster/tufts/hugheslab/zhuang12/HCI/fNIRS-mental-workload-classifiers/experiments/generic_models/DeepConvNet/binary/16vs4/TestBucket8/$SubjectId_of_interest"
