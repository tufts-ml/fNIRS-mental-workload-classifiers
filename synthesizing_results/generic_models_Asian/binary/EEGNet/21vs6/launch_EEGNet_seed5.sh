...
do
    export experiment_dir="/cluster/tufts/hugheslab/zhuang12/HCI/NuripsDataSet2021/experiments/FixedTrainValSplit_generic_models/AsianSubset/EEGNet/binary/21vs6/seed5/$SubjectId_of_interest"
