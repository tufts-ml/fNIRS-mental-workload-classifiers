...
do
    export experiment_dir="/cluster/tufts/hugheslab/zhuang12/HCI/NuripsDataSet2021/experiments/FixedTrainValSplit_generic_models/WhiteSubset/EEGNet/binary/21vs6/seed2/$SubjectId_of_interest"
