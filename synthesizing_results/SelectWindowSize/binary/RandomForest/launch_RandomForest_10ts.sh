...
do
    export experiment_dir="/cluster/tufts/hugheslab/zhuang12/HCI/NuripsDataSet2021/experiments/FixedTrainValSplit_SelectWindowSize/RandomForest/binary/window_size10/$SubjectId_of_interest"
