...
do
    export experiment_dir="YOUR_PATH/fNIRS-mental-workload-classifiers/experiments/domain_adaptation/LogisticRegression/binary/train_100/64vs4/TestBucket9/$SubjectId_of_interest"
