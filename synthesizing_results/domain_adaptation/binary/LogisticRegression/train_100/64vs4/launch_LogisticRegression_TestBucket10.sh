...
do
    export experiment_dir="/cluster/tufts/hugheslab/zhuang12/HCI/NuripsDataSet2021/experiments/FixedTrainValSplit_domain_adaptation/LogisticRegression/binary/train_100/64vs4/TestBucket10/$SubjectId_of_interest"
