...
def main(experiment_dir, summary_save_dir):
    ...
    '''
    experiment_dir: /cluster/tufts/hugheslab/zhuang12/HCI/NuripsDataSet2021/experiments/FixedTrainValSplit_generic_models/WhiteSubset/RandomForest/binary/21vs6/seed1
    '''
