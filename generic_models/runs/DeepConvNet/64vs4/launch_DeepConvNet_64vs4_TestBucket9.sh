...
export result_save_rootdir="$YOUR_PATH/fNIRS-mental-workload-classifiers/experiments/FixedTrainValSplit_generic_models/DeepConvNet/binary/$scenario/$bucket" 
export n_epoch=600
export restore_file="None"

if [[ $ACTION_NAME == "submit" ]]; then
    ## Use this line to submit the experiment to the batch scheduler
    sbatch < $YOUR_PATH/fNIRS-mental-workload-classifiers/generic_models/runs/do_experiment_DeepConvNet.slurm
