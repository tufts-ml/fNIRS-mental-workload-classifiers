...
export result_save_rootdir="/cluster/tufts/hugheslab/zhuang12/HCI/fNIRS-mental-workload-classifiers/experiments/FixedTrainValSplit_generic_models/DeepConvNet/binary/$scenario/$bucket" 
export n_epoch=600
