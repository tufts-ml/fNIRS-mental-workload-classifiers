...
export result_save_rootdir="/cluster/tufts/hugheslab/zhuang12/HCI/fNIRS-mental-workload-classifiers1/experiments/generic_models/LogisticRegression/binary/$scenario/$bucket" 
