...
export result_save_rootdir="/cluster/tufts/hugheslab/zhuang12/HCI/NuripsDataSet2021/experiments/generic_models/LogisticRegression/binary/$scenario/$bucket" 
