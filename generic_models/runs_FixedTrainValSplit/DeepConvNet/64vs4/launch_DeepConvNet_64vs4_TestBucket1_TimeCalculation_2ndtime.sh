...
export result_save_rootdir="/cluster/tufts/hugheslab/zhuang12/HCI/NuripsDataSet2021/experiments/FixedTrainValSplit_generic_models/DeepConvNet/binary/time_calculation_2ndtime/$scenario/$bucket" 
export n_epoch=600
