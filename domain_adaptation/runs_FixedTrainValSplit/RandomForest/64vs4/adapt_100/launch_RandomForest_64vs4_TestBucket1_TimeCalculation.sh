...
export result_save_rootdir="/cluster/tufts/hugheslab/zhuang12/HCI/NuripsDataSet2021/experiments/FixedTrainValSplit_domain_adaptation/RandomForest/binary/time_calculation/$adapt_on/$scenario/$bucket" 
