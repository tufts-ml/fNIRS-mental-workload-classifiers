...
export result_save_rootdir='/cluster/tufts/hugheslab/zhuang12/HCI/fNIRS-mental-workload-classifiers/experiments/subject_specific_models/EEGNet/binary/window_size150'
...
do
    ...
    if [[ $ACTION_NAME == 'submit' ]]; then
        ...
        sbatch < /cluster/tufts/hugheslab/zhuang12/HCI/fNIRS-mental-workload-classifiers/subject_specific_models/runs/do_experiment_EEGNet.slurm
    
    elif [[ $ACTION_NAME == 'run_here' ]]; then
        ## Use this line to just run interactively
        bash /cluster/tufts/hugheslab/zhuang12/HCI/fNIRS-mental-workload-classifiers/subject_specific_models/runs/do_experiment_EEGNet.slurm
    fi
