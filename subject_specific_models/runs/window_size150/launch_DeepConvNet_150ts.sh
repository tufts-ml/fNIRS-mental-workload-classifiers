...
do
    ...
    if [[ $ACTION_NAME == 'submit' ]]; then
        ...
        sbatch < YOUR_PATH/fNIRS-mental-workload-classifiers/subject_specific_models/runs/do_experiment_DeepConvNet.slurm
    
    elif [[ $ACTION_NAME == 'run_here' ]]; then
        ## Use this line to just run interactively
        bash YOUR_PATH/fNIRS-mental-workload-classifiers/subject_specific_models/runs/do_experiment_DeepConvNet.slurm
    fi
